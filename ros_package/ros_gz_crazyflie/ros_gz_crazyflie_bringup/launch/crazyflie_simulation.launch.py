...
def generate_launch_description():
    nbDrone_arg =  os.getenv('NB_DRONES', '3')
    ...
    for i in range(int(nbDrone_arg)):
        control = Node(
            ...
            parameters=[
                ...
                {'incoming_twist_topic': f'/cmd_vel{i}'},
                {'max_ang_z_rate': 0.4},
            ]
        )
        node_to_launch.append(control)
